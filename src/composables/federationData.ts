    ...
    offices: [
      {
        id: 1,
        title: 'ΓΓ-ΟΤΑΠΠΑ',
        description: 'Γενική Γραμματεία Ομοσπονδιακού Τμήματος Άμυνας, Πολιτικής Προστασίας και Αθλητισμού',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 2,
        title: 'Ελληνικές Ένοπλες Δυνάμεις',
        description: 'Ομάδα Άμυνας',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 3,
        title: 'ΕΥΠ',
        description: 'Ομοσπονδιακή Υπηρεσία Πληροφοριών',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 4,
        title: 'ΟΓΠΠ',
        description: 'Ομοσπονδιακό Γραφείο Πολιτικής Προστασίας',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 5,
        title: 'ΟΓΚ',
        description: 'Ομοσπονδιακό Γραφείο Κυβερνοασφάλειας',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 6,
        title: 'Αρμαπρό',
        description: 'Ομοσπονδιακό Γραφείο Προμηθειών Άμυνας',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 7,
        title: 'ΟΑΘ',
        description: 'Ομοσπονδιακό Αθλητικό Γραφείο',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 8,
        title: 'Τοπογραφείο',
        description: 'Ομοσπονδιακό Γραφείο Τοπογραφίας',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 9,
        title: 'ΑΑΕΔ',
        description: 'Ανεξάρτητη Αρχή Εποπτείας Δραστηριοτήτων Πληροφοριών',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 10,
        title: 'ΕΝΒιβ',
        description: 'Βιβλιοθήκη Ενόπλων Δυνάμεων Ελλάδας',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 11,
        title: 'ΓΕΣΔ',
        description: 'Γραφείο Εισαγγελέα Στρατιωτικής Δικαιοσύνης',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 12,
        title: 'ΚΓΠΑ',
        description: 'Κρατική Γραμματεία Πολιτικής Ασφαλείας',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 13,
        title: 'ΕΑΘΕ',
        description: 'Ελληνικό Ομοσπονδιακό Ινστιτούτο Αθλητισμού',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 14,
        title: 'ΕΔΑ',
        description: 'Ελληνικό Δίκτυο Ασφαλείας',
        supportingText: '',
        link: '#',
        staff: [],
      },
    ...
    offices: [
      {
        id: 1,
        title: 'ΓΓ-ΟΤΔΙΑ',
        description: 'Γενική Γραμματεία Ομοσπονδιακού Τμήματος Δικαιοσύνης και Αστυνομίας',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 2,
        title: 'ΕΔΔ',
        description: 'Επιτροπή Διαιτησίας Δικαιωμάτων',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 3,
        title: 'ΑΑΕ',
        description: 'Εποπτική Αρχή Ελεγκτών',
        supportingText: '',
        link: '#',
        staff: [],
      },
      ...
      },
      {
        id: 5,
        title: 'ΙΜΕΤ',
        description: 'Ινστιτούτο Μετρολογίας',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 6,
        title: 'ΟΔΔ',
        description: 'Ομοσπονδιακό Γραφείο Δικαιοσύνης',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 7,
        title: 'ΟΑΣ',
        description: 'Ομοσπονδιακό Γραφείο Αστυνομίας',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 8,
        title: 'ΕΕΠΒ',
        description: 'Εθνική Επιτροπή για την Πρόληψη Βασανιστηρίων',
        supportingText: '',
        link: '#',
        staff: [],
      },
      ...
      },
      {
        id: 10,
        title: 'ΥΕΤΤ',
        description: 'Υπηρεσία Εποπτείας Ταχυδρομείων και Τηλεπικοινωνιών',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 11,
        title: 'ΚΓΜ',
        description: 'Κρατική Γραμματεία Μετανάστευσης',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 12,
        title: 'ΙΔΙ',
        description: 'Ομοσπονδιακό Ινστιτούτο Διανοητικής Ιδιοκτησίας',
        supportingText: '',
        link: '#',
        staff: [],
      },
      {
        id: 13,
        title: 'ΙΣΔ',
        description: 'Ελληνικό Ινστιτούτο Συγκριτικού Δικαίου',
        supportingText: '',
        link: '#',
        staff: [],
      },
