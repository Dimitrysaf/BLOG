  ...
  >
    <div class="image-url-field">
      <div class="image-preview">
        <cdx-progress-indicator v-if="isLoadingImage" />
        <img
...
const creationDate = ref(new Date().toLocaleDateString('el-GR'));
...
watch(articleTitle, (newTitle) => {
  articleSlug.value = slugify(newTitle);
});
